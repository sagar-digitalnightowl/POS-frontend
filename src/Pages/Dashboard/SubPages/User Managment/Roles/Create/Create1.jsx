...
const Create1 = () => {
  ...
  const addAgents = async () => {
    try {
      const response = await fetch(`${process.env.REACT_APP_BASE_URL}/admin/userManagement/role/addRole`, {
        method: 'POST',
        headers: {
  ...
  const [permissions, setPermissions] = useState({
    ...
    viewCustomersWithNoSellFromOneMonthOnly: false,
    viewCustomersWithNoSellFromThreeMonthsOnly: false,
    viewCustomersWithNoSellFromSixMonthsOnly: false,
    viewCustomersWithNoSellFromOneYearOnly: false,
    viewCustomersIrrespectiveOfTheirSell: false,
    addCustomer: false,
    editCustomer: false,
    ...
    viewallPurchaseAndStockAdjustment: false,
    viewOwnPurchaseAndStockAdjustment: false,
    addPurchaseAndStockAdjustment: false,
    editPurchaseAndStockAdjustment: false,
    deletePurchaseAndStockAdjustment: false,
    ...
    updateSell: false,
    deleteSell: false,
    commissionAgentCanViewTheirOwnSell: false,
    addSellPayment: false,
    editSellPayment: false,
    deleteSellPayment: false,
    editProductPriceFromSalesScreen: false,
    editProductDiscountFromSaleScreen: false,
    addOrEditOrDeleteDiscount: false,
    ...
    accessPendingShipmentsOnly: false,
    commissionAgentCanAccessTheirOwnShipments: false,
    ...
    viewPurchaseAndSellReport: false,
    viewTaxReport: false,
    viewSupplierAndCustomerReport: false,
    viewExpenseReport: false,
    viewProfitOrLossReport: false,
    viewStockReportAndstockAdjustmentReportAndStockExpiryReport: false,
    ...
    accessAccountingModule: false,
    manageAccounts: false,
    viewJournal: false,
    addJournal: false,
    editJournal: false,
    deleteJournal: false,
    mapTransactions: false,
    viewTransfer: false,
    addTransfer: false,
    editTransfer: false,
    ...
    manageBudget: false,
    viewReports: false,
    accessAllFollowUp: false,
    accessOwnFollowUp: false,
    accessAllLeads: false,
    accessOwnLeads: false,
    accessAllCampaigns: false,
    accessOwnCampaigns: false,
    AccessContactLogin: false,
    accessSources: false,
    accessLifeStage: false,
    accessProposal: false,
    AddOrEditOrViewOrDeleteLeaveType: false,
    AddOrEditOrViewOrDeleteAllLeave: false,
    addOrViewOwnLeave: false,
    approveLeave: false,
    addOrEditOrViewOrDeleteAllAttendance: false,
    viewOwnAttendance: false,
    allowUsersToEnterTheirOwnAttendanceFromWeb: false,
    allowUsersToEnterTheirOwnAttendanceFromApi: false,
    viewPayComponent: false,
    addPayComponent: false,
    addOrEditOrViewOrDeleteDepartment: false,
    addOrEditOrViewOrDeleteDesignation: false,
    viewAllPayroll: false,
    addPayroll: false,
    editPayroll: false,
    deletePayroll: false,
    assignToDosToOthers: false,
    addToDos: false,
    editToDos: false,
    deleteToDos: false,
    createMessage: false,
    viewMessage: false,
    accessSalesTargets: false,
    addInvoice: false,
    editInvoice: false,
    ...
    addOrEditOrDeleteJobSheetStatus: false,
    addJobSheet: false,
    editJobSheet: false,
