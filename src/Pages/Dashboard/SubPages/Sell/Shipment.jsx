    ...
    <div style={textStyle}>
        <div className="wrapper thetop">
            ...
            <div className=" content-wrapper ">
                <section className="content-header no-print"><h1>Shipments </h1></section>
                                ...
                                <div className="col-md-3">
                                    ...
                                    <div className="col-md-3">
                                        <div className="form-group">
                                            ...
                                            <select className="form-control select2" style={{ width: "100%" }} id="delivery_person" name="delivery_person">
                                                <option value="" selected="selected"> All</option>
                                                <option value={4}> POS APPLICATION ADMIN </option>
                                            </select>
                                        </div>
