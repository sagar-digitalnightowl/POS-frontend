...
const EditDraft = () => {
  ...
  const fetchDraft = async () => {
    ...
    try {
      ...
      const res = await apiCall({ method: "get", url: `/admin/sell/draftList/getDraft/${id}` })
  ...
  const editDraft = async (formData) => {
    setLoading(true);
    try {
      const res = await apiCall({ method: "patch", url: `/admin/sell/draftList/updateDraft/${id}`, data: formData });

      if (res.status === 200) {
        navigate('/sells/drafts')
      } else {
        setError(res?.data?.message)
      }
    ...
    <div style={textStyle}>
      <div className="wrapper thetop">
        ...
        <div className=" content-wrapper ">
          <section className="content-header"><h1>Edit Draft</h1></section>
