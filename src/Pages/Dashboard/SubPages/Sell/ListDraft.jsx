...
const ListDraft = () => {
    ...
    // console.log(data, "data on draft page")
    ...
    const fetchDraftList = async () => {
        ...
        try {
            ...
            const res = await apiCall({ method: "get", url: `/admin/sell/draftList/getAllDraft?${params.toString()}` });
    ...
    const deleteDraft = async (id) => {
        setLoading(true);
        try {
            const res = await apiCall({ method: "delete", url: `/admin/sell/draftList/deleteDraft/${id}` });
        ...
        <div style={textStyle}>
            <div className="wrapper thetop">
                ...
                <div className=" content-wrapper ">
                    <section className="content-header no-print"> <h1>Drafts </h1> </section>
                        ...
                        <div className="box box-primary">
                            <div className="box-header">
                                ...
                                <div className="box-tools">
                                    <Link className="btn btn-block btn-primary" to="/add/drafts">
                                        <FontAwesomeIcon icon={faPlus} className="fa fa-plus" /> Add Draft
                                    </Link>
                                </div>
                            </div>
                            <div className="box-body">
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <td>
                                                        <DropdownButton id="dropdown-basic-button" title="Actions">
                                                            ...
                                                            <Dropdown.Item onClick={() => navigate(`/edit/draft/${group?._id}`)}> <FontAwesomeIcon icon={faEdit} /> Edit </Dropdown.Item>
                                                            <Dropdown.Item onClick={() => deleteDraft(group?._id)}> <FontAwesomeIcon icon={faTrash} /> Delete</Dropdown.Item>
