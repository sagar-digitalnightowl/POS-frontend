...
const AddSale = () => {
  ...
  const addSale = async (formData) => {
    setLoading(true);
    try {
      const res = await apiCall({ method: "post", url: `/admin/sell/saleList/addSales`, data: formData });
    ...
    <div style={textStyle}>
      <div className="wrapper thetop">
        ...
        <div className=" content-wrapper ">
          <section className="content-header"><h1>Add Sale</h1></section>
                        ...
                        <div className="form-group">
                          ...
                          <div className="input-group">
                            ...
                            <input
                              ...
                              type="date"
                              defaultValue=""
                              value={formData.payments.paidOn}
                              onChange={handleChangePayments}
                            />
                          </div>
                        </div>
