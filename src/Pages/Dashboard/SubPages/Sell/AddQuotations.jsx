...
import { faMapMarker, faUser, faPlusCircle, faInfoCircle, faCalendar, faSearchPlus, faTimes, faInfo, faGift, faChevronDown, faChevronUp, faPlus, faTrash, faSearch } from '@fortawesome/free-solid-svg-icons';
...
const AddQuotations = () => {
  ...
  const addQuotation = async (formData) => {
    setLoading(true);
    try {
      const res = await apiCall({ method: "post", url: `/admin/sell/quotationList/addquotation`, data: formData });
    ...
    <div style={textStyle}>
      <div className="wrapper thetop">
        ...
        <div className=" content-wrapper ">
          <section className="content-header"><h1>Add Quotation</h1></section>
