...
const AddStockTransfer = () => {
  ...
  const handleAddStockTransfer = async (e) => {
    e.preventDefault();
    setLoading(true);
    try {
      const res = await apiCall({ method: "post", url: `/admin/stockTransfer/stockList/addStockTransfer`, data: formData });
      ...
      setError(error.message);
      console.log("Error in create new stock transfer : ", error)
    } finally {
      setLoading(true);
    }
  }
      ...
      <div className="wrapper thetop" style={textStyle}>
        ...
        <div className=" content-wrapper ">
          ...
          <section className="content no-print">
            ...
            <form onSubmit={handleAddStockTransfer}>
