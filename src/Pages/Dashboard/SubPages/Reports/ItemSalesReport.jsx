...
const ItemSalesReport = () => {
    const[data, setData] = useState([
        {product:'Sefam', sku:'0101',sale:'01',customer:'Anish', location:'POS APPLIACTION',sellQuantity:'6 boxes',
        sellingPrice:'BD 490.000',subTotal:'BD 2940.000'}
    ]);
                  ...
                  <input type="text" className="form-control form-control-sm" placeholder="Search..." onChange={(e) => console.log(e.target.value)} />
                    ...
                    {currentItems.map((user, index) => (
                      <tr key={index}>
                        ...
                        <td style={textStyle}>{user.sellDate}</td>
                        <td style={textStyle}>{user.sale}</td>
                        <td style={textStyle}>{user.customer}</td>
                        <td style={textStyle}>{user.location}</td>
                        <td style={textStyle}>{user.sellQuantity}</td>
                        <td style={textStyle}>{user.sellingPrice}</td>
