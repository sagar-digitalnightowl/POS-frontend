...
import './AddContactDetail.css';

const AddContactDetail = ({ show, onClose, data }) => {
    // Main form state
    ...
    const addCustomer = async (customerData) => {
        try {
            setLoading(true);
            if (customerData.isIndividual) {
                customerData['individual'] = true;
                customerData['business'] = false;
            } else {
                customerData['business'] = true;
                customerData['individual'] = false;
            }
    ...
    const handleSubmit = (e) => {
        ...
        if (data && data._id) {
            updateCustomer(formData, data._id);
        } else {
