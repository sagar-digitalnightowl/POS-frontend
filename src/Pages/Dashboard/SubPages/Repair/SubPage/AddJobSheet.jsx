...
const AddJobSheet = () => {
    ...
    const addJobSheet = async (formDataToSend) => {
        try {
            console.log(formDataToSend);

            setLoading(true);

            const response = await fetch(`${process.env.REACT_APP_BASE_URL}/admin/repair/jobSheet/addJobSheet`, {
                method: 'POST',
                headers: {},
                body: formDataToSend
            });
            ...
            <div className="wrapper thetop">
                ...
                <div className="content-wrapper">
                    ...
                    <section className="content-header no-print">
                        <h1> Job sheet <small>Create</small> </h1>
                    </section>
