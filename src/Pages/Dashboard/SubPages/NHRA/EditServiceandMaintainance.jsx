...
const EditServiceandMaintainance = () => {
  ...
  const fetchServiceAndMaintainanceById = async () => {
    setLoading(true);
    try {
      const res = await apiCall({
        method: "get",
        url: `/admin/nhra/serviceMaintenance/getServiceMaintenance/${id}`,
      })
      ...
      console.log("Error in get Service and Maintainance by id : ", error)
    } finally {
      setLoading(false);
    }
  }
  ...
  useEffect(() => {
    ...
    fetchServiceAndMaintainanceById();
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await apiCall({
        method: "patch",
        url: `/admin/nhra/serviceMaintenance/updateServiceMaintenance/${id}`,
        data: formData
      })
      if (res.status === 200) {
      ...
      setError(error.message);
      console.log("Error in Edit Service and Maintainance: ", error)
    } finally {
      setLoading(false);
    }
  }
      ...
      <div className="wrapper thetop">
        ...
        <div className=" content-wrapper ">
          <section className="content-header">
            <h1>Edit Service &amp; Maintenance</h1>
          </section>
...
export default EditServiceandMaintainance