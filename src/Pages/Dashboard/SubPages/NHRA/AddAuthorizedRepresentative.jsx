...
const AddAuthorizedRepresentative = () => {
    ...
    const addAuthorizedRepresentative = async (data) => {
        setLoading(true);
        try {
            const res = await apiCall({
                method: "post",
                url: `/admin/nhra/authorizedRepresentativeList/addAuthorizedRepresentative`,
                data: data
            })
            if (res.status === 201) {
                navigate('/ar')
    ...
    const handleSubmit = (e) => {
        ...
        addAuthorizedRepresentative(form);
    }
            ...
            <div className="wrapper thetop">
                ...
                <div className=" content-wrapper ">
                    <section className="content-header">
                        <h1>Add Authorized Representative</h1>
                    </section>
...
export default AddAuthorizedRepresentative