...
const AddFieldSafetyNotice = () => {
  ...
  const addFieldSafetyNotice = async (data) => {
    setLoading(true);
    try {
      const res = await apiCall({
        method: "post",
        url: `/admin/nhra/safetyNoticeList/addSafetyNotice`,
        data: data
      })
      if (res.status === 201) {
...
export default AddFieldSafetyNotice