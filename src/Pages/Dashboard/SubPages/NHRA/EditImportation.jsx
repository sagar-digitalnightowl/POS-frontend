...
const EditImportation = () => {
    ...
    const fetchImporationById = async () => {
        try {
            setLoading(true);
            const res = await apiCall({
                method: "get",
                url: `/admin/nhra/importationList/getImportation/${id}`
            });

            if (res.status == 200) {
                setFormData({
                    ...res?.data?.result, invoice: null,
                    purchaseOrder: null,
                    catalogue: null,
    ...
    const editImportation = async (data) => {
        try {
            ...
            const res = await apiCall({
                method: "patch",
                url: `/admin/nhra/importationList/updateImportation/${id}`,
                data: data
            });
            ...
            if (res.status == 200) {
                ...
                throw new Error("Failed to edit importation");
            }
        } catch (error) {
            console.log(error);
            setError(error.message);
                                            ...
                                            <form className="tab-wizard wizard-circle wizard clearfix" onSubmit={handleSubmit}>
                                                <div className="card card-secondary">
                                                    <div className="card-header">
                                                        <h3 className="card-title">Edit Imports</h3>
                                                    </div>
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="form-group col-md-6">
                                                                ...
                                                                <input type="date" name="dateOfDelivery" id="dateofdelivery"
                                                                    ...
                                                                    value={formData.dateOfDelivery?.substring(0, 10) || ''}
                                                                    onChange={handleChange}
                                                                />
                                                            </div>
                                                                                    ...
                                                                                    <tr id="objDiv0">
                                                                                        ...
                                                                                        <td>
                                                                                            <input
                                                                                                ...
                                                                                                className="form-control"
                                                                                                name="expiry"
                                                                                                value={formData?.products[index]?.expiry?.substring(0, 10) || 0}
                                                                                                onChange={(e) => handleProductChange(index, e)}
                                                                                            />
                                                                                        </td>
                                                                                        <td>
