...
const AddPurchaseReturn = () => {
  ...
  const addPurchaseReturn = async (data) => {
    ...
    try {
      const res = await apiCall({
        method: "post",
        url: `/admin/purchase/purchaseReturn/addPurchaseReturn`,
        data: data
      })
      ...
      setError(error.message);
      console.log("Error in add purchase return : ", error)
    } finally {
      setLoading(false);
    }
  }
    ...
    <div style={textStyle}>
      <div className="wrapper thetop">
        ...
        <div className=" content-wrapper ">
          <section className="content-header"><h1> Add Purchase Return</h1></section>
