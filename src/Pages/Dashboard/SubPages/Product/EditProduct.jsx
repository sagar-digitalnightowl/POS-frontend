...
const EditProduct = () => {
  ...
  const fetchProduct = async () => {
    try {
      setLoading(true);
      const response = await fetch(`${process.env.REACT_APP_BASE_URL}/admin/product/productList/getProduct/${id}`, {
        method: 'GET',
        headers: {
  ...
  const editProductData = async (formDataToSend) => {
    try {
      setLoading(true);

      const response = await fetch(`${process.env.REACT_APP_BASE_URL}/admin/product/productList/updateProduct/${id}`, {
        method: 'PATCH',
        headers: {},
        body: formDataToSend
      });
  ...
  const handleSubmit = (e) => {
    ...
    editProductData(formDataToSend);
  }
                      ...
                      <div className="col-sm-4">
                        <div className="form-group">
                          ...
                          >
                            ...
                            <option value={"MIDDLE PEARL TRADING COMPANY W.L.L"} >
                              MIDDLE PEARL TRADING COMPANY W.L.L (BL0001)
                            </option>
                          </select>
                        </div>
                      </div>
                        ...
                        <div className="form-group">
                          ...
                          <label>
                            <input
                              ...
                              name="manageStock"
                              type="checkbox"
                              defaultValue={formData?.manageStock}
                              onChange={(e) => handleChange(e)}
                            />{" "}
                        ...
                        <div className="form-group">
                          ...
                          <label>
                            <input
                              ...
                              type="checkbox"
                              defaultValue={formData?.enableProductDescriptionImeiOrSerialNumber}
                              onChange={(e) => handleChange(e)}
                            />
                            <strong>
                        ...
                        <div className="form-group">
                          ...
                          <label>
                            <input
                              ...
                              name="notForSelling"
                              type="checkbox"
                              defaultValue={formData?.notForSelling}
                              onChange={(e) => handleChange(e)}
                            />
                      ...
                      <div className="col-sm-3">
                        <div className="form-group">
                          ...
                          <select
                            ...
                            onChange={(e) => handleChange(e)}
                          >
                            <option value="" selected="selected"> Select Use Type </option>
