      ...
      <div className="wrapper thetop" style={textStyle}>
        ...
        <div className="content-wrapper">
          ...
          <section className="content">
            <h4>
              All memos <small> Manage all your memos</small>
            </h4>
            <div className="box box-solid">
              <div className="box-header">
                <h4 className="box-title">All memos</h4>
                <div className="box-tools pull-right">
                  <button type="button" className="btn btn-sm btn-primary add_memo" onClick={toggleFormVisibility}>
                ...
                {showForm && ( 
                  <div className="row">
                    <div className="col-md-12">
                      <form method="POST"action="https://medipro.affinity-me.com/essentials/document"
                          ...
                          <div className="col-sm-12">
                            <div className="col-sm-6">
                              <div className="form-group">
                                ...
                                <input className="form-control"required=""name="name"type="text"id="name"/>
                              </div>
                            </div>
