      ...
      <div className="col-md-12 no-print pos-header">
        <div className="row">
          ...
          <div className="col-md-6">
            ...
            <Link to="/pos/create" title="Add Repair" data-toggle="tooltip" data-placement="bottom" className="btn bg-purple btn-flat m-6 btn-xs m-5 pull-right" style={buttonStyle}>
